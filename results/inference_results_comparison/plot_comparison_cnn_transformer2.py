...
def main():
    transformer_path = '/scratch/tvs9by/ntia/pathprofile/inference_results4_plot_comparison/prediction_results_OID182_PID10.csv'
    cnn_path = '/scratch/tvs9by/ntia/pathprofile/inference_results4_plot_comparison/inference_pid10_oid182.csv'
    output_path = '/scratch/tvs9by/ntia/pathprofile/inference_results4_plot_comparison/comparison_plot_pid10_oid182.png'
    ...
    vmin_pl = min(actual_loss_grid.min().min(), cnn_pred_grid.min().min())
    vmax_pl = max(actual_loss_grid.max().max(), cnn_pred_grid.max().max())
