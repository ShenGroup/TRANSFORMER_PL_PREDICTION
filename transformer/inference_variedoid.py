...
output_dir = "/scratch/tvs9by/ntia/pathprofile/inference_results4_allinone_unified_big_varied_oid"
...
def main():
    ...
    filtered_data = df_file[(df_file['OID'].between(184,193)) & (df_file['PID'].between(2,2))]
