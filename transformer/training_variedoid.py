...
if __name__ == "__main__":
    ...
    # Data directories
    train_dir1 = "/scratch/tvs9by/ntia/pathprofile/trainingdata/trainingdata3/training"
    train_dir2 = "/scratch/tvs9by/ntia/pathprofile/trainingdata/trainingdata4/training"
    ...
    train_files1 = []
    train_files = sorted(train_files1 + train_files2)
    ...
    cache_dir = os.path.join(ckpt_dir, "cache_chunksvariedoid")
    
    # Load datasets
    print("\nLoading datasets...")
    
    train_ds_v4_raw = VarLenDatasetV4(filelist=train_files, max_seq_len=max_seq_len, cache_mode=True, cache_dir=cache_dir, apply_oid_filter=False)
